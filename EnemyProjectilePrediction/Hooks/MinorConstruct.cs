        ...
        public static void Init()
        {
            ...
            IL.EntityStates.GenericProjectileBaseState.FireProjectile += (il) =>
            {
                    ...
                    ))
                {
                    ...
                    {
                        if ((!loopOnly || (Run.instance && Run.instance.stageClearCount >= 5)) && self.GetType() == typeof(EntityStates.MinorConstruct.Weapon.FireConstructBeam))
                        {
                            if (self.characterBody && !self.characterBody.isPlayerControlled && (!AccurateEnemiesPlugin.eliteOnly || self.characterBody.isElite))
                            {
