    ...
    public class Scavenger
    {
        ...
        public static void Init()
        {
            ...
            IL.EntityStates.ScavMonster.FireEnergyCannon.OnEnter += (il) =>
            {
                    ...
                    ))
                {
                    ...
                    c.EmitDelegate<Func<Ray, EntityStates.ScavMonster.FireEnergyCannon, Ray>>((aimRay, self) =>
                    {
                        if (self.characterBody && !self.characterBody.isPlayerControlled)
                        {
                            ...
                            Ray newAimRay = Util.PredictAimrayPS(aimRay, self.GetTeam(), AccurateEnemiesPlugin.basePredictionAngle, EntityStates.ScavMonster.FireEnergyCannon.projectilePrefab, targetHurtbox);
                            return newAimRay;
                        }
                        return aimRay;
                    });
                ...
                {
                    Debug.LogError("AccurateEnemies: EntityStates.ScavMonster.FireEnergyCannon.OnEnter IL Hook failed");
                }
            };
        }
    }
